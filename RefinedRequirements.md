...
* Candidates cannot apply for the job directly or browse through the available job postings inside the portal. This work is done by AI engine on behalf of users.
...
* Candidates have access to job postings inside the portal and can apply directly if they find a fit and AI engine will track this knowledge to avoid duplicate submission. 
